...
import numpy as np
import torchvision
from WGAN_Generator_complex import Generator
...
def plot_random_latent_images(generator, name):
    ...
    plt.savefig(f'WGAN_generatedImages_{name}.png')
    return fake_imgs


generator = Generator().cuda()
G = torch.load(f"W_generator_complex", map_location=torch.device('cuda'))
...
#(1.1658311023108088, 0.11641261637161456)
