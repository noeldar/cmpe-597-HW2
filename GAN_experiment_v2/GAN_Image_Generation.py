...
import numpy as np
import torchvision
from GAN_Generator_weak import Generator
...
def plot_random_latent_images(generator, name):
    for i in range(100):
        ...
        data = np.load(f"vae/content/random_{i}.npy")
...
G = torch.load(f"generator_weak", map_location=torch.device('cuda'))
fake_imgs = plot_random_latent_images(G, "weak")
...
#(1.0001301752355556, 4.046424692214112e-05)--complex
#(1.0000000000000049, 7.226178903471276e-15)--middle
#(1.0964638450393804, 0.03706775349001842)--weak
